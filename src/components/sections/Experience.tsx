          ...
          <div className="grid md:grid-cols-2 gap-6">
            {certifications.map((cert, index) => (
              <motion.div
                ...
                className="glass-effect p-6 rounded-xl border border-white/10 dark:border-white/10 border-slate-200/50 hover:border-white/20 dark:hover:border-white/20 hover:border-slate-300/50 transition-all duration-300 group bg-white/90 dark:bg-transparent"
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <h4 className="text-lg font-semibold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300">
                      {cert.name}
                    </h4>
                    <p className="text-blue-600 dark:text-blue-300 font-medium">{cert.issuer}</p>
                  </div>
