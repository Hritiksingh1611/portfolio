...
const experiences = [
  ...
  },
  {
    ...
    duration: "2018 — 2022",
    type: "Education",
    typeColor: "bg-purple-500/15 text-purple-600 dark:text-purple-400 border-purple-500/30",
    description:
...
const certifications = [
  ...
  { name: "AWS Certified Data Engineer",          issuer: "Amazon AWS",   year: "2024", image: "/aws-certified-data-engineer-associate (3).png",     credlyUrl: "https://www.credly.com/badges/25563f35-bb02-45e8-9705-e092548f22f4/public_url" },
  ...
  { name: "GCP Cloud Engineer",                   issuer: "Google Cloud", year: "2025", image: "/associate-cloud-engineer-certification (3).png",     credlyUrl: "https://www.credly.com/badges/03b452c6-a3dd-49ad-9b19-32652d17eb81/public_url" },
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-5">
            <span className="font-mono text-[10px] text-neutral-400 dark:text-neutral-700 tracking-[0.25em] uppercase shrink-0">03 — Experience</span>
          ...
          <div className="space-y-8">
            {experiences.map((exp, i) => (
              ...
              >
                {/* Timeline node */}
                <div
                  className="absolute left-4 top-6 w-4 h-4 rounded-full border-2 border-white dark:border-[#0c0c1a]"
                  style={{ background: exp.accent, boxShadow: `0 0 12px ${exp.accent}80` }}
                />

                <div className="glass rounded-2xl p-6 border border-neutral-200/70 dark:border-white/[0.08] hover:border-violet-500/20 transition-all duration-300">
                  {/* Header row */}
                  <div className="flex flex-wrap items-start gap-3 mb-4">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-display font-bold text-neutral-900 dark:text-white text-lg leading-tight">{exp.title}</h3>
                      <p className="text-violet-600 dark:text-indigo-400 font-medium text-sm mt-0.5">{exp.company}</p>
                    </div>
                  ...
                  <ul className="space-y-1.5 mb-5">
                    {exp.achievements.map((a) => (
                      <li key={a} className="flex items-start gap-2 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        >
          ...
          <h3 className="font-display font-bold text-2xl text-neutral-900 dark:text-white mb-10">
            Certifications
          </h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {certifications.map((cert, i) => (
              ...
              >
                {/* Badge image */}
                <div className="relative w-16 h-16 rounded-xl bg-neutral-100 dark:bg-white/5 border border-neutral-200 dark:border-white/10 overflow-hidden shrink-0">
                  <Image
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-neutral-900 dark:text-white font-semibold text-sm leading-snug group-hover:text-violet-600 dark:group-hover:text-indigo-300 transition-colors line-clamp-2">
                    {cert.name}
                  </p>
